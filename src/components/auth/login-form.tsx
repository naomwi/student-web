  ...
  return (
    <div className="mx-auto w-full max-w-md space-y-6 p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      <div className="text-center">
        ...
        <p className="text-sm text-gray-500 mt-2">Đăng nhập để tiếp tục học tập</p>
      </div>
      ...
      <div className="text-center text-sm">
        Chưa có tài khoản? <a href="/register" className="font-semibold text-blue-600 hover:underline">Đăng ký ngay</a>
      </div>
    </div>
  );
}
