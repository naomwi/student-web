...
export function GroupCard({ group }: { group: GroupProps }) {
  ...
  return (
    <div className="bg-white p-5 rounded-lg border shadow-sm flex flex-col justify-between h-full hover:shadow-md transition">
      <div>
        ...
        <div className="space-y-2 mb-4 text-sm text-gray-600">
           ...
           {group.isMember && group.meetingLink && (
             <a href={group.meetingLink} target="_blank" className="flex items-center text-blue-600 hover:underline">
