    ...
    <div className="space-y-10 pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="bg-white dark:bg-[#1e1e1e] rounded-3xl border border-slate-100 dark:border-white/5 shadow-xl shadow-slate-200/50 dark:shadow-none overflow-hidden group">
              ...
              {upcomingGroups?.length === 0 ? (
                ...
                <div className="space-y-4">
                  {upcomingGroups?.map((item: any, idx) => (
                    <div key={idx} className="flex items-center justify-between p-5 bg-white dark:bg-[#262626] rounded-2xl border border-slate-100 dark:border-white/5 shadow-sm hover:border-indigo-200 dark:hover:border-indigo-500/30 hover:shadow-md transition duration-300">
                      <div>
          ...
          {/* Report Section */}
          {isAdmin && (
            <div className="bg-white dark:bg-slate-800 rounded-3xl border border-rose-100 dark:border-rose-900/30 shadow-xl shadow-rose-100/50 dark:shadow-none overflow-hidden">
